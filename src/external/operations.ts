...
export const reverseRow = <T = unknown>(
  row: number,
  columns: number,
  mat: T[]
): T[] => {
...
export const reverseColumn = <T = unknown>(
  column: number,
  columns: number,
  mat: T[]
): T[] => {
...
export const reverseDiagonal = <T = unknown>(
  size: number,
  mat: T[],
  direction: '\\' | '/' = '\\'
): T[] => {
...
export const swapRows = <T = unknown>(
  a: number,
  b: number,
  columns: number,
  mat: T[]
...
export const swapColumns = <T = unknown>(
  a: number,
  b: number,
  columns: number,
  mat: T[]
  ...
  for (
    let aI = a, bI = b;
    mat[aI] !== undefined && mat[bI] !== undefined;
    aI += columns, bI += columns
  ) {
    m[aI] = mat[bI];
    m[bI] = mat[aI];
  }
...
export const addColumn = <T = unknown>(
  index: number,
  values: T[],
  columns: number,
  mat: T[]
...
export const removeRow = <T = unknown>(
  index: number,
  columns: number,
  mat: T[]
): T[] => {
...
export const removeColumn = <T = unknown>(
  index: number,
  columns: number,
  mat: T[]
): T[] => {
...
export const replaceRow = <T = unknown>(
  index: number,
  values: T[],
  columns: number,
  mat: T[]
...
export const replaceColumn = <T = unknown>(
  index: number,
  values: T[],
  columns: number,
  mat: T[]
...
export const sortRow = <T = unknown>(
  ...
  return replaceRow<T>(
    index,
    getRow<T>(index, columns, mat).sort(sorter),
    columns,
    mat
  );
};
...
export const sortColumn = <T = unknown>(
  ...
  return replaceColumn<T>(
    index,
    getColumn<T>(index, columns, mat).sort(sorter),
    columns,
    mat
  );
};
